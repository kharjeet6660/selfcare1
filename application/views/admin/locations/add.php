					...
					<div class='card'>
						<div class="card-header">
							<div class="row align-items-center">
								<div class="col">                      
									<h4 class="card-title">Create Location</h4>     <?php $this->load->view('includes/flashdata'); ?>                                                            
								</div>                              
							</div>
							<div class='card-body'>
								<div class="container-fluid  p-3">
									<?php echo form_open(base_url('admin/locations'),'enctype="multipart/form-data"') ?>
									<div class="row">
										<div class="row p-2">
											<div class="col-sm-6 p-2">
												<div class="form-group p-2">
													<label for="">Address 1</label>
													<input type="text" name="address1"  class="form-control"value="<?php echo set_value('address1');?>">
										...
										<div class="form-group col-md-6">
											...
											<select required="true" name="city" class="form-control" id="inputDistrict">
										...
										<div class="row p-2">
											<div class="col-sm-6 p-2">
												<div class="form-group p-2">
													...
													<input type="email" name="primary_email"  class="form-control" value="<?php echo set_value('primary_email');?>">
											...
											<div class="col-sm-6 p-2">
												<div class="form-group p-2">
													...
													<input type="text" name="primary_contact"  class="form-control" value="<?php echo set_value('primary_contact');?>">
