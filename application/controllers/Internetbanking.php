...
class Internetbanking extends Application_Controller {
  ...
  public function index() {
    ...
    $config['base_url'] = base_url('Internetbanking/index');
    ...
    $this->load->view('Internetbanking/index',$data);
  }

  public function new () {
  	$data['branches'] = $this->Internetbanking_model->getbranch();
    $this->load->view('Internetbanking/add',$data);
  }
  public function create(){
    ...
    else
    {
      ...
      $this->Internetbanking_model->create($request);
      $this->session->set_flashdata('success', 'Your issue request has been sent to our team!');
      redirect(base_url('internet-banking-request'));
    }
  }
}
